...
// tableExpand_cpp
std::string tableExpand_cpp(CharacterVector cells, IntegerVector colsWidth, IntegerVector charWidth, 
    CharacterVector justify, CharacterVector sepCols, std::string style);
RcppExport SEXP pander_tableExpand_cpp(SEXP cellsSEXP, SEXP colsWidthSEXP, SEXP charWidthSEXP, 
    SEXP justifySEXP, SEXP sepColsSEXP, SEXP styleSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    ...
    Rcpp::traits::input_parameter< IntegerVector >::type charWidth(charWidthSEXP );
    ...
    __result = Rcpp::wrap(tableExpand_cpp(cells, colsWidth, charWidth, justify, sepCols, style));
    return __result;
END_RCPP
}
